...
class StoicQuoteEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set STOICISM_QUOTE_TEST_STOIC_QUOTE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def stoic_quote_basic_setup(extra)
  ...
  entid_env_raw = ENV["STOICISM_QUOTE_TEST_STOIC_QUOTE_ENTID"]
