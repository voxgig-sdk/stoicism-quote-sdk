...
#      offline in seeded test mode (StoicismQuoteSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "StoicismQuote_sdk.rb")
  SDK_CLASS = "StoicismQuoteSDK"
