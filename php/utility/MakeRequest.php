...
class StoicismQuoteMakeRequest
{
    public static function call(StoicismQuoteContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new StoicismQuoteResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new StoicismQuoteResponse($fetched);
        } else {
