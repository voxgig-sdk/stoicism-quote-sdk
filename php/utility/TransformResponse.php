...
// StoicismQuote SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class StoicismQuoteTransformResponse
{
    public static function call(StoicismQuoteContext $ctx): mixed
    {
        ...
        $transform = StoicismQuoteHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
