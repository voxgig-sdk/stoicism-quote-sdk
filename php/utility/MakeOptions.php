...
// StoicismQuote SDK utility: make_options

class StoicismQuoteMakeOptions
{
    ...
    public static function call(StoicismQuoteContext $ctx): array
    {
        ...
        //
        // `StoicismQuoteSchema::optspec()` is built from the model:
        ...
        $optspec = StoicismQuoteSchema::optspec();
