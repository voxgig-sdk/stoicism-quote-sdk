...
class StoicQuoteEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set STOICISMQUOTE_TEST_STOIC_QUOTE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function stoic_quote_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("STOICISMQUOTE_TEST_STOIC_QUOTE_ENTID");
