...
// StoicismQuote SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (StoicismQuoteSDK::test)
...
{
    private const SDK_CLASS = 'StoicismQuoteSDK';
    ...
    private const SDK_BASE = 'stoicismquote_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../stoicismquote_sdk.php';
