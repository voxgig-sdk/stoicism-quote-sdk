...
class StoicismQuoteTestRunner
{
    ...
    {
        $live = self::getenv('STOICISM_QUOTE_TEST_LIVE');
        $override = self::getenv('STOICISM_QUOTE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('STOICISM_QUOTE_TEST_EXPLAIN');
...
class_alias('StoicismQuoteTestRunner', 'Runner');
class_alias('StoicismQuoteHelpers', 'Helpers');
