...
class StoicQuoteDirectTest extends TestCase
{
    public function test_direct_load_stoic_quote(): void
    {
        $setup = stoic_quote_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-stoic_quote", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
