...
// StoicismQuote SDK utility type

class StoicismQuoteUtility
{
    ...
    public static function copy(StoicismQuoteUtility $src): StoicismQuoteUtility
    {
        $u = new StoicismQuoteUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
