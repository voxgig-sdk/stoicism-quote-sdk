...
// StoicismQuote SDK netsim feature
...
class StoicismQuoteNetsimFeature extends StoicismQuoteBaseFeature
{
    ...
    private function _simulate(StoicismQuoteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(StoicismQuoteContext $ctx, array $applied): void
    {
        $client = $this->client;
