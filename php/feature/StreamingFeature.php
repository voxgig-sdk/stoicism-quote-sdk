...
// StoicismQuote SDK streaming feature
...
class StoicismQuoteStreamingFeature extends StoicismQuoteBaseFeature
{
    ...
    private function _iterate(StoicismQuoteResult $result): \Generator
    {
    ...
    private function _streamable(StoicismQuoteContext $ctx): bool
    {
