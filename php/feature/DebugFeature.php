...
// StoicismQuote SDK debug feature
...
class StoicismQuoteDebugFeature extends StoicismQuoteBaseFeature
{
    ...
    private function _finish(StoicismQuoteContext $ctx, bool $ok): void
    {
