...
// StoicismQuote SDK metrics feature
...
class StoicismQuoteMetricsFeature extends StoicismQuoteBaseFeature
{
    ...
    private function _record(StoicismQuoteContext $ctx, bool $ok): void
    {
