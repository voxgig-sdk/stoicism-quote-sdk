...
// StoicismQuote SDK proxy feature
...
class StoicismQuoteProxyFeature extends StoicismQuoteBaseFeature
{
    ...
    public function init(StoicismQuoteContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (StoicismQuoteContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
