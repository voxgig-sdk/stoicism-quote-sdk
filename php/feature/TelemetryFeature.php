...
// StoicismQuote SDK telemetry feature
...
class StoicismQuoteTelemetryFeature extends StoicismQuoteBaseFeature
{
    ...
    private function _close(StoicismQuoteContext $ctx, bool $ok): void
    {
