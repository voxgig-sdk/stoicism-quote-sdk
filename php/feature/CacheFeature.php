...
// StoicismQuote SDK cache feature
...
class StoicismQuoteCacheFeature extends StoicismQuoteBaseFeature
{
    ...
    private function _through(StoicismQuoteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
