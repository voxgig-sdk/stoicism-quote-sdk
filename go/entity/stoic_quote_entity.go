...
type StoicQuoteEntity struct {
	name    string
	client  *core.StoicismQuoteSDK
...
func NewStoicQuoteEntity(client *core.StoicismQuoteSDK, entopts map[string]any) *StoicQuoteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StoicQuoteEntity) GetName() string { return e.name }
...
func (e *StoicQuoteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StoicQuoteEntity) Deleted() bool {
	return e.deleted
}


func (e *StoicQuoteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStoicQuoteEntity(e.client, opts)
}

func (e *StoicQuoteEntity) Data(args ...any) any {
...
func (e *StoicQuoteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an StoicQuote; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StoicQuoteEntity) DataTyped(data ...StoicQuote) StoicQuote {
	if len(data) > 0 {
		return typedFrom[StoicQuote](e.Data(asMap(data[0])))
	}
	return typedFrom[StoicQuote](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through StoicQuote (all fields
// optional at the wire level).
func (e *StoicQuoteEntity) MatchTyped(match ...StoicQuote) StoicQuote {
	if len(match) > 0 {
		return typedFrom[StoicQuote](e.Match(asMap(match[0])))
	}
	return typedFrom[StoicQuote](e.Match())
}
...
func (e *StoicQuoteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StoicQuoteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StoicQuoteLoadMatch and returns an StoicQuote. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StoicQuoteEntity) LoadTyped(reqmatch StoicQuoteLoadMatch, ctrl map[string]any) (StoicQuote, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return StoicQuote{}, err
	}
	return typedFrom[StoicQuote](res), nil
}



func (e *StoicQuoteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *StoicQuoteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StoicQuoteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StoicQuoteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StoicQuoteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
