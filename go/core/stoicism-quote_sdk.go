...
func (sdk *StoicismQuoteSDK) OptionsMap() map[string]any {
...
func (sdk *StoicismQuoteSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *StoicismQuoteSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *StoicismQuoteSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StoicismQuoteSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *StoicismQuoteSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *StoicismQuoteSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("StoicismQuoteSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *StoicismQuoteSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StoicismQuoteSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("StoicismQuoteSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *StoicismQuoteSDK {
	...
	sdk := NewStoicismQuoteSDK(sdkopts)
	sdk.Mode = "test"
