...
func TestStoicQuoteEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set STOICISMQUOTE_TEST_STOIC_QUOTE_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func stoic_quoteBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("STOICISMQUOTE_TEST_STOIC_QUOTE_ENTID")
