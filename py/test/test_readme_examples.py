# StoicismQuote SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions StoicismQuoteSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both StoicismQuoteSDK(...) and StoicismQuoteSDK.test(...) become
#      StoicismQuoteSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "stoicismquote_sdk"
_SDK_CLASS = "StoicismQuoteSDK"
