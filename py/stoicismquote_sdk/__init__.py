...
from stoicismquote_sdk.utility import register

# Load features
from stoicismquote_sdk.feature.base_feature import StoicismQuoteBaseFeature
from stoicismquote_sdk.features import _has_feature, _make_feature
...
class StoicismQuoteSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = StoicismQuoteUtility()
        self._utility = utility

        from stoicismquote_sdk.config import shared_config
    ...
    def get_utility(self):
        return StoicismQuoteUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("StoicismQuoteSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def StoicQuote(self, data=None) -> "StoicQuoteEntity":
        ...
        from stoicismquote_sdk.entity.stoic_quote_entity import StoicQuoteEntity
