...
from stoicismquote_sdk.core.control import StoicismQuoteControl
...
from stoicismquote_sdk.core.helpers import get_ctx_prop, to_map
...
class StoicismQuoteContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = StoicismQuoteControl()
        ...
        if isinstance(sp, StoicismQuoteSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, StoicismQuoteResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, StoicismQuoteResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return StoicismQuoteError(code, msg, self)
