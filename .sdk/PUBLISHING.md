...
|---|---|---|
| `ts/` | @voxgig-sdk/stoicism-quote-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/stoicism-quote-sdk \
      --repository voxgig-sdk/stoicism-quote-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/stoicism-quote-sdk` shows it, and
`npm trust revoke @voxgig-sdk/stoicism-quote-sdk --id=<id>` removes it.
