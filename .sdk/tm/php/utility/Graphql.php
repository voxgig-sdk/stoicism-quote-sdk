...
// StoicismQuote SDK utility: graphql
//
...
class StoicismQuoteGraphql
{
    ...
    // equivalent.
    public static function body(StoicismQuoteContext $ctx): mixed
    {
    ...
    public static function errors(StoicismQuoteContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
