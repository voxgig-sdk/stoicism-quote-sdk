...
// StoicismQuote SDK utility: fetcher

class StoicismQuoteFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; StoicismQuoteSDK/1.0)';
    ...
    public static function call(StoicismQuoteContext $ctx, string $fullurl, array $fetchdef): array
    {
