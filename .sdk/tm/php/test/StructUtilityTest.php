...
// StoicismQuote SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = StoicismQuoteOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(StoicismQuoteOmni::structfix($now, Struct::undef()))
                        !== json_encode(StoicismQuoteOmni::structfix($val, Struct::undef()))) {
