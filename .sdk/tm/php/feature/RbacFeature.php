...
// StoicismQuote SDK rbac feature
...
class StoicismQuoteRbacFeature extends StoicismQuoteBaseFeature
{
    ...
    private function _required(StoicismQuoteContext $ctx): ?string
    {
    ...
    private function _reject(StoicismQuoteContext $ctx, string $required): void
    {
    ...
    private function _track(StoicismQuoteContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
