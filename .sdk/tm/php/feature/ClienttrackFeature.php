...
// StoicismQuote SDK clienttrack feature
...
class StoicismQuoteClienttrackFeature extends StoicismQuoteBaseFeature
{
    ...
    public function PostConstruct(StoicismQuoteContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'StoicismQuote-SDK';
