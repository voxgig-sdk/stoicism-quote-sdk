...
// StoicismQuote SDK audit feature
...
class StoicismQuoteAuditFeature extends StoicismQuoteBaseFeature
{
    ...
    private function _emit(StoicismQuoteContext $ctx, string $outcome): void
    {
