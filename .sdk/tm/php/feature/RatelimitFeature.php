...
// StoicismQuote SDK ratelimit feature
...
class StoicismQuoteRatelimitFeature extends StoicismQuoteBaseFeature
{
    ...
    private function _acquire(StoicismQuoteContext $ctx): void
    {
    ...
    private function _track(StoicismQuoteContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
