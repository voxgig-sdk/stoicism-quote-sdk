...
// StoicismQuote SDK timeout feature
...
class StoicismQuoteTimeoutFeature extends StoicismQuoteBaseFeature
{
    ...
    private function _with_timeout(StoicismQuoteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(StoicismQuoteContext $_ctx, float $ms): void
    {
        $client = $this->client;
