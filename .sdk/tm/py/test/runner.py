...
class StoicismQuoteTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StoicismQuoteTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = StoicismQuoteTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = StoicismQuoteTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
