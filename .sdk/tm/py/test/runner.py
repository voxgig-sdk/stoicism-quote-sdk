...
class StoicismQuoteTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StoicismQuoteTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = StoicismQuoteTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = StoicismQuoteTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
