...
function envOverride(m) {
    if ('TRUE' === process.env.STOICISM_QUOTE_TEST_LIVE ||
        'TRUE' === process.env.STOICISM_QUOTE_TEST_OVERRIDE) {
    ...
    m.STOICISM_QUOTE_TEST_EXPLAIN = process.env.STOICISM_QUOTE_TEST_EXPLAIN || m.STOICISM_QUOTE_TEST_EXPLAIN;
    return m;
}
