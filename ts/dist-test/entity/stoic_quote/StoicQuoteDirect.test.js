...
(0, node_test_1.describe)('StoicQuoteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.StoicismQuoteSDK({
    ...
    (0, node_test_1.test)('direct-load-stoic_quote', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-stoic_quote', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.STOICISM_QUOTE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.StoicismQuoteSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['STOICISM_QUOTE_TEST_STOIC_QUOTE_ENTID'];
    ...
    const client = new __1.StoicismQuoteSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=StoicQuoteDirect.test.js.map