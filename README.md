...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/stoicism-quote` | `npm install @voxgig-sdk/stoicism-quote` |
| Python | `voxgig-sdk-stoicism-quote` | `pip install voxgig-sdk-stoicism-quote` |
| PHP | `voxgig-sdk/stoicism-quote` | `composer require voxgig-sdk/stoicism-quote` |
| Golang | `github.com/voxgig-sdk/stoicism-quote-sdk/go` | `go get github.com/voxgig-sdk/stoicism-quote-sdk/go` |
| Ruby | `voxgig-sdk-stoicism-quote` | `gem install voxgig-sdk-stoicism-quote` |
| Lua | `voxgig-sdk-stoicism-quote` | `luarocks install voxgig-sdk-stoicism-quote` |
