...
describe("StoicQuoteDirect", function()
  it("should direct-load-stoic_quote", function()
    local setup = stoic_quote_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-stoic_quote", setup.live and "live" or "unit")
...
function stoic_quote_direct_setup(mockres)
