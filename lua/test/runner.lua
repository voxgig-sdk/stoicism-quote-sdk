...
function runner.env_override(m)
  local live = runner.getenv("STOICISMQUOTE_TEST_LIVE")
  local override = runner.getenv("STOICISMQUOTE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("STOICISMQUOTE_TEST_EXPLAIN")
