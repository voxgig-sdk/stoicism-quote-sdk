...
function runner.env_override(m)
  local live = runner.getenv("STOICISM_QUOTE_TEST_LIVE")
  local override = runner.getenv("STOICISM_QUOTE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("STOICISM_QUOTE_TEST_EXPLAIN")
