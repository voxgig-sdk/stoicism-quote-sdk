...
func registerSDKWords(r *eng.Registry, client *sdk.StoicismQuoteSDK) {
...
func runOp(client *sdk.StoicismQuoteSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
