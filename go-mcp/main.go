// Command StoicismQuote-mcp is an MCP server exposing the StoicismQuote
// SDK as MCP tools.
//
// Two tools are registered:
//
//	StoicismQuote_list  — list records of an entity
//	StoicismQuote_load  — load a single record of an entity
//
