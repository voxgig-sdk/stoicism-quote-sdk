...
type Args struct {
	Entity string         `json:"entity" jsonschema:"stoic_quote"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.StoicismQuoteSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "stoicism-quote_list",
		Description: "List records from StoicismQuote. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "stoicism-quote_load",
		Description: "Load a single record from StoicismQuote. " +
...
func runOp(client *sdk.StoicismQuoteSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.StoicismQuoteSDK, name string) (sdk.StoicismQuoteEntity, error) {
	switch strings.ToLower(name) {
	case "stoic_quote":
		return client.StoicQuote(nil), nil
